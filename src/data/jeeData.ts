...
// Define the enhanced chapter icons with 3D-style emojis
export const chapterIcons: Record<string, string> = {
  // Mathematics icons - Enhanced 3D style
  ...
  // Physics icons - Enhanced 3D style
  ...
  // Chemistry icons - Enhanced 3D style
