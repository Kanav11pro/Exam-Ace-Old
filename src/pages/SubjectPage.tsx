...
import { ChevronLeft, Clock, BarChart3, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5">
      <div className="container max-w-6xl py-8">
              ...
              <Popover open={showQuickStats} onOpenChange={setShowQuickStats}>
                ...
                <PopoverContent className="w-80">
                  <div className="space-y-2">
                    <h3 className="font-medium text-foreground">Quick Stats for {subject}</h3>
        ...
        {isTimerActive && activeChapter && (
          <Card className="mb-6 border-green-500/20 shadow-lg">
            <CardContent className="p-4">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="text-2xl font-mono mt-1 text-foreground">{formatTime(timerSeconds)}</div>
                </div>
                <div className="flex space-x-2">
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-green-500/20 hover:border-green-500/30 hover:bg-green-500/10"
                    onClick={stopTimer}
                  >
            ...
            <div key={chapter} className="relative group">
              ...
              {!isTimerActive && (
                <button
                  ...
                  className="absolute top-2 right-2 bg-background/90 p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity shadow-sm hover:shadow"
