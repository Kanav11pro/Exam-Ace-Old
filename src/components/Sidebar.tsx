...
export const Sidebar = () => {
  ...
  return (
    <motion.div 
      className="fixed left-0 top-14 bottom-0 bg-gradient-to-b from-background via-background/95 to-background/90 backdrop-blur-xl border-r border-border/50 h-[calc(100vh-3.5rem)] z-20 shadow-2xl hidden md:flex flex-col overflow-hidden"
    ...
    >
      ...
      <div className="flex-1 py-6 flex flex-col overflow-hidden relative">
        <motion.ul 
